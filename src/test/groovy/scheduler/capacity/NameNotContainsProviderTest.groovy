...
class NameNotContainsProviderTest extends Specification {
    ...
    def "provide"() {
        ...
        def cut = new NameNotContainsProvider(matchingName, capacity)
        ...
        'dummy'           | 'other'      | 1.0f     | 1.0f
        'dummy'           | 'dummy'      | 0.0f     | 0.0f
        'dummy'           | 'dummy'      | 1.0f     | 0.0f
        'long dummy name' | 'dummy'      | 2.0f     | 0.0f
    }
}
